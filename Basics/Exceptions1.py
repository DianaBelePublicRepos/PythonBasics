try:
    #Open the file names people.csv
    thefile = open('people.csv')
#Watch for common error and stop program if it happens
except FileNotFoundError:
    print("Sorry, I don't see a file names people.csv here")
#Catch any unexpected error and stop program if one happens
except Exception as err:
    print(err)
#Otherwise, if nothing bad has happened until now, just keep going
else:
